...
const algorithmMessage = `Wich machine learning algorithm do you want to use? \nType 1 for KNN\nType 2 for Decision Tree `;
...
if(algorithm == 2)
{
	...
	var dt = new DecisionTree(set[0], result);
	dt.build();
	...
	console.log("Player league (evaluation) : ", dt.classify(evaluation1));
	console.log("Player league (evaluation) : ", dt.classify(evaluation2));
	console.log("Player league (existing) : ",   dt.classify(evaluation3));
	console.log("Player league (existing) : ",   dt.classify(evaluation4));
	console.log("Player league (existing) : ",   dt.classify(evaluation5));
}
